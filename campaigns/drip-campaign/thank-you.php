...
if($_POST["email"] != '' OR $_POST["phone"] != ''): 
    ...
    $EmailSubject = "Drip Campaign :: Techniecode"; 
    $mailheader = "From: "."Michael Mergle <abhishekhar.g@techniecode.com>"."\r\n"; 
...
<head>
<meta charset="UTF-8">
<title>Drip Campaign :: Techniecode, Inc.</title>
<!-- responsive meta -->
...
<div class="banner" style="height:150px;"> </div>
<div class="why-section">
  <div class="why-top">
    ...
    text-align: center;
    color: #fff;
    margin-bottom: 10px;">Thank You!</h1>
        ...
        <p style="transition: none; line-height: 24px; border-width: 0px; margin: 0px 0px 10px; padding: 0px; letter-spacing: 0px; font-weight: 400; font-size: 14px;">We have received your message and will contact you soon.<br />
          <br style="transition: none; line-height: 24px; border-width: 0px; margin: 0px; padding: 0px; letter-spacing: 0px; font-weight: 400; font-size: 14px;">
          - Techniecode Team</p>
      </div>
    </div>
  </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="single-footer-widget">
          ...
          <ul class="service-list">
            ...
            <li>113 Barksdale Professional Center</li>
